...
# --- Load Keyword Map ---
# Load keyword_map from external file or compress further if needed
keyword_map = {
...
"trends": performance
}  # <-- You can refactor into a separate file for cleanliness
...
async def ask_edutrack(query: Query):
    ...
    group.append_message({"role": "user", "name": "Student", "content": user_query})
    manager.run()
